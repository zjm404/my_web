...
gulp.task("scss", function() { 
	return scssTask("static.js.editormd");
}); 

gulp.task("scss2", function() { 
	return scssTask("static.js.editormd.preview");
}); 

gulp.task("scss3", function() {
	return scssTask("static.js.editormd.logo");
}); 
...
gulp.task("js", function() { 
  return gulp.src("./src/editormd.js")
            ...
            .pipe(gulp.dest("./"))
            .pipe(notify({ message: "static.js.editormd.js task complete" }));
}); 
