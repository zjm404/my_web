...
!function (t, e, i) {
    ...
    var i = "zui.pager", n = {page: 1, recTotal: 0, recPerPage: 10}, o = {
        ...
        s.lang = t.isPlainObject(r) ? t.extend(!0, {}, o[r.lang || t.zui.clientLang()], r) : o[r], s.state = {}, s.set(n.page, n.recTotal, n.recPerPage, !0), s.$.on("click", ".pager-goto-btn", function () {
    ...
    a.prototype.set = function (e, i, o, a) {
        ...
        return "string" == typeof o ? o.format(t.extend({}, n, {page: i})) : t.isFunction(o) ? o(i, n) : "#page=" + i
 ...
 */
    ...
    s.DEFAULTS = o, s.NAME = n, s.prototype.trigger = function (e, i) {
        ...
        var o, a, s, r, l, c, d, p, h, u, f, g, m, v = this, y = v.$, b = v.options, w = b.deviation,
            ...
            D = b.handle, E = b.flex, S = b.container, z = b.canMoveHere, P = b.dropToClass, I = y, M = !1,
            O = S ? t(b.container).first() : k ? y : t("body"), j = function (e) {
                if (M && (f = {left: e.pageX, top: e.pageY}, !(i.abs(f.left - p.left) < w && i.abs(f.top - p.top) < w))) {
                    if (null === s) {
                        var n = O.css("position");
                        "absolute" != n && "relative" != n && "fixed" != n && (c = n, O.css("position", "relative")), s = I.clone().removeClass("drag-from").addClass("drag-shadow").css({
                            position: "absolute",
                            width: I.outerWidth(),
                            transition: "none"
                        }).appendTo(O), I.addClass("dragging"), v.trigger("start", {event: e, element: I, targets: o})
                    }
                    ...
                    if (o.each(function () {
                        ...
                        if (f.left > a && f.top > s && f.left < a + n && f.top < s + o && (C && C.removeClass(P), C = e, !b.nested)) return !1
                    }), C) {
                        r = !0;
                        var $ = C.data("id");
                        I.data("id") != $ && (l = !1), (null === a || a.data("id") !== $ && !l) && (y = !0), a = C, E && o.removeClass(P), a.addClass(P)
                    }
                    E ? null !== a && a.length && (r = !0) : (I.toggleClass("drop-in", r), s.toggleClass("drop-in", r)), z && z(I, a) === !1 || v.trigger("drag", {
                        event: e,
                        isIn: r,
                        target: a,
                        element: I,
                ...
                if (t(e).off(C), clearTimeout(m), M) {
                    ...
                    n = v.trigger("beforeDrop", y), n && r && v.trigger("drop", y), o.removeClass(P), I.removeClass("dragging").removeClass("drag-from"), s.remove(), s = null, v.trigger("finish", y), v.trigger("always", y), i && i.preventDefault()
                }
            }, A = function (i) {
                ...
                if (!(n > -1 && i.button !== n)) {
                    ...
                    k && (I = D ? f.closest(k) : f), I.hasClass("drag-shadow") || b.before && b.before({
                        event: i,
                        element: I
                    }) === !1 || (M = !0, o = t.isFunction(b.target) ? b.target(I, y) : O.find(b.target), a = null, s = null, r = !1, l = !0, c = null, d = I.offset(), h = O.offset(), h.top = h.top - O.scrollTop(), h.left = h.left - O.scrollLeft(), p = {
                        left: i.pageX,
                        top: i.pageY
                    }, g = t.extend({}, p), u = {
                        left: p.left - d.left,
    ...
    o.prototype.toggle = function (t, e) {
        ...
        if (i === e && (i = s.position), i !== e && null !== i) {
            ...
            var r = o.$element.find(".modal-dialog"), l = t(window).height(),
                c = {maxHeight: "initial", overflow: "visible"}, d = r.find(".modal-body").css(c);
            if (s.scrollInside) {
                var p = s.headerHeight;
                "number" != typeof p ? p = r.find(".modal-header").height() : t.isFunction(p) && (p = p($header)), c.maxHeight = l - p, d.outerHeight() > c.maxHeight && (c.overflow = "auto")
            }
            d.css(c);
            var h = Math.max(0, (l - r.outerHeight()) / 2);
            if ("fit" === i ? i = {top: h > 50 ? Math.floor(2 * h / 3) : h} : "center" === i ? i = {top: h} : t.isPlainObject(i) || (i = {top: i}), r.hasClass("modal-moveable")) {
                var u = null, f = s.rememberPos;
                f && (f === !0 ? u = o.$element.data("modal-pos") : t.zui.store && (u = t.zui.store.pageGet(n + ".rememberPos." + f))), i = t.extend(i, {left: Math.max(0, (t(window).width() - r.outerWidth()) / 2)}, u), "inside" === s.moveable ? a(r, i) : r.css(i)
            } else r.css(i)
        }
        ...
        a.$element.trigger(s), a.$element.toggleClass("modal-scroll-inside", !!a.options.scrollInside), a.isShown || s.isDefaultPrevented() || (a.isShown = !0, a.options.moveable && a.setMoveale(), a.checkScrollbar(), a.options.backdrop !== !1 && (a.$body.addClass("modal-open"), a.setScrollbar()), a.escape(), a.$element.on("click.dismiss." + n, '[data-dismiss="modal"]', function (t) {
            a.hide(), t.stopPropagation()
        }), a.backdrop(function () {
            var s = t.support.transition && a.$element.hasClass("fade");
            a.$element.parent().length || a.$element.appendTo(a.$body), a.$element.show().scrollTop(0), s && a.$element[0].offsetWidth, a.$element.addClass("in").attr("aria-hidden", !1), a.ajustPosition(i), a.enforceFocus();
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            if (this.$backdrop = t('<div class="modal-backdrop ' + a + '" />').appendTo(this.$body), this.$element.on("mousedown.dismiss." + n, t.proxy(function (t) {
    ...
    r.DEFAULTS = {
        ...
        p("onShow", "show"), p("shown", "shown"), p("onHide", "hide"), p("hidden", "hidden"), p("loaded", "loaded"), d.on("shown" + a, function () {
            r.isShown = !0
        ...
        var a = t.extend({}, this.options, {url: this.$trigger ? this.$trigger.attr("href") || this.$trigger.attr("data-url") || this.$trigger.data("url") : this.options.url}, i);
        this.init(a);
        var r = this, l = this.$modal, c = this.$dialog, d = a.custom, p = c.find(".modal-body").css("padding", ""),
            h = c.find(".modal-header"), u = c.find(".modal-content");
        l.toggleClass("fade", a.fade).addClass(a.className).toggleClass("modal-loading", !this.isShown).toggleClass("modal-scroll-inside", !!a.scrollInside), c.toggleClass("modal-md", "md" === a.size).toggleClass("modal-sm", "sm" === a.size).toggleClass("modal-lg", "lg" === a.size).toggleClass("modal-fullscreen", "fullscreen" === a.size), h.toggle(a.showHeader), h.find(".modal-icon").attr("class", "modal-icon icon-" + a.icon), h.find(".modal-title-name").text(a.title || ""), a.size && "fullscreen" === a.size && (a.width = "", a.height = "");
        var f = function () {
            ...
            return "undefined" == typeof t && (t = a.delay), setTimeout(function () {
                c = l.find(".modal-dialog"), a.width && "auto" != a.width && c.css("width", a.width), a.height && "auto" != a.height && (c.css("height", a.height), "iframe" === a.type && p.css("height", c.height() - h.outerHeight())), r.ajustPosition(a.position), l.removeClass("modal-loading"), "iframe" != a.type && c.off("resize." + n).on("resize." + n, f), e && e()
            }, t)
        };
        if ("custom" === a.type && d) if (t.isFunction(d)) {
            var m = d({modal: l, options: a, modalTrigger: r, ready: g});
            typeof m === s && (p.html(m), g())
        } else d instanceof t ? (p.html(t("<div>").append(d.clone()).html()), g()) : (p.html(d), g()); else if (a.url) {
            var v = function () {
            ...
            if (l.attr("ref", a.url), "iframe" === a.type) {
                ...
                var y = "iframe-" + a.name;
                h.detach(), p.detach(), u.empty().append(h).append(p), p.css("padding", 0).html('<iframe id="' + y + '" name="' + y + '" src="' + a.url + '" frameborder="no"  allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"  allowtransparency="true" scrolling="auto" style="width: 100%; height: 100%; left: 0px;"></iframe>'), a.waittime > 0 && (r.waitTimeout = g(a.waittime, v));
                        ...
                        try {
                            ...
                            if (o && "auto" === a.height && "fullscreen" != a.size) {
                                ...
                                var c = [], d = function (n) {
                                    l.removeClass("fade");
                                    var o = s.outerHeight();
                                    if (n === !0 && a.onlyIncreaseHeight && (o = Math.max(o, p.data("minModalHeight") || 0), p.data("minModalHeight", o)), i) {
                                ...
                                l.callComEvent(r, "loaded", {
                                    modalType: "iframe",
                                    jQuery: o
                                }), setTimeout(d, 100), s.off("resize." + n).on("resize." + n, d), i && t(e).off("resize." + n).on("resize." + n, d)
                            } else g()
                        } catch (u) {
                            g()
                        }
                ...
                url: a.url, success: function (i) {
                    try {
                        var n = t(i);
                        n.filter(".modal-dialog").length ? c.replaceWith(n) : n.filter(".modal-content").length ? c.find(".modal-content").replaceWith(n) : p.wrapInner(n)
                    } catch (a) {
                    ...
                    l.callComEvent(r, "loaded", {modalType: o}), g()
                }, error: v
            }, a.ajaxOptions))
        }
        l.modal({
        ...
        (i || n) && o.$modal.on("hidden" + a, function () {
            t.isFunction(i) && i(), typeof n === s && n.length && !o.$modal.data("cancel-reload") && ("this" === n ? e.location.reload() : e.location = n)
        }), o.$modal.modal("hide")
        ...
        return t(this).each(function () {
            ...
            a || o.data(n, a = new r(l, o)), typeof e == s ? a[e](i) : l.show && a.show(i), o.on((l.trigger || "click") + ".toggle." + n, function (e) {
